...
void main() {
  group('crud', () {
    ...
    test('calc total of month', () async {
      expect(
          debitRegisterStore,
          emitValues([
      ...
      HomeSuccessRegisterState homeSuccessRegisterState = getTotal(DebitRegisterStore.homeSuccessRegisterState.creditCardList) as HomeSuccessRegisterState;
      expect(homeSuccessRegisterState.total, 200);
    });
  });
}
